<%@ Page Title="" Language="C#" MasterPageFile="~/boardMain.master" AutoEventWireup="true" CodeFile="default2.aspx.cs" Inherits="MRME_default" EnableSessionState="True" %>
            ...
            <div class="form-group">
                <div class="col-md-3">
                    ...
                    <select class="form-control" id="category" name="category" runat="server">        
                        <option value="matrixNumber" selected="selected"> Matrix Number</option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group stylish-input-group">
                        ...
                        <span class="input-group-addon">
                            <button id="searchButton" runat="server">
            ...
            <div id="divSearchResult">
                <div class="box box-solid">
                    <div class="box-header with-border" style="background-color:#00A65A;">
                        <h3 class="box-title" style="color:White; font-weight:bold;">Search result</h3>
                    ...
                    <div class="box-body">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-hover"
                            DataSourceID="SqlDataSource1" AllowPaging="True" PageSize="10" GridLines="None" AllowSorting="True"
                            ForeColor="#333333" HorizontalAlign="Center" Width="90%" EmptyDataText="Patient Record Not Found" 
                            EnableViewState="False" onselectedindexchanged="GridView1_SelectedIndexChanged">
                            ...
                            <SelectedRowStyle BackColor="#E36E60" ForeColor="White" Font-Bold="True" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>">
                            ...
                            <SelectParameters>
                                <asp:ControlParameter ControlID="searchKey" Name="searchTerm" PropertyName="Text" Type="String" />
                            </SelectParameters>
                            <%--<FilterParameters>
                                <asp:ControlParameter Name="Name" ControlID="txtFind" runat="server" />
                            </FilterParameters>--%>
                        </asp:SqlDataSource>
                        <%--Search : 
                        <asp:TextBox ID="txtFind" runat="server" AutoPostBack="True"></asp:TextBox>
                        <input type="submit" id="btSubmit" value="search" runat="server" />--%>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function collapseSearchResult() {
            $("[data-widget='collapse']").first().click();
        }
    </script>
</asp:Content>
