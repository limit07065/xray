            ...
            <div id="partThree" runat="server" clientidmode="static" style="display:none;">
                <div class="form-inline">
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-block btn-primary" onclick="viewDICOM(); return false;">X-Ray Image</button>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function viewDICOM() {
            window.open("DICOMViewer.aspx", 'dicomViewer', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=800,height=750,left=20,top=20');
        }
    </script>
</asp:Content>
